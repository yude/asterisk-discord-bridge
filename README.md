...
音声キューはリアルタイム性を優先します。Asterisk受信側は通常の揺らぎを吸収するjitter windowを持ち、処理停止やネットワーク停滞で既定100 msの高水位を超えた場合だけ、古いフレームを破棄して最新40 msまで追いつきます。このため、短い揺らぎで音声を欠落させず、数秒前の音声を遅れて再生し続けることもありません。
